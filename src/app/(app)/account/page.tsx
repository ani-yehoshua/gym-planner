    ...
    <div className="flex flex-col gap-8">
      ...
      <form action={updateAccount} className="flex flex-col gap-5">
            ...
            {(["lb", "kg"] as const).map((u) => (
              ...
              >
                <input
                  ...
                  name="units"
                  value={u}
                  defaultChecked={(profile?.units ?? "lb") === u}
                  className="sr-only"
                />
                {u}
              </label>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className={field}>
            <label className={label} htmlFor="current_bodyweight">Bodyweight</label>
            <input
          ...
          <div className={field}>
            <label className={label} htmlFor="target_bodyweight">Target</label>
            <input
          ...
          <div className={field}>
            <label className={label} htmlFor="weekly_gain_target">+/wk</label>
            <input
      ...
      <form action="/auth/signout" method="post" className="border-t border-border pt-6">
        <button className="text-sm text-text-muted hover:text-rose-400">Sign out</button>
      </form>
    </div>
  );
}
